...
<li>
    <h4 style="color:red">Booking No #<?php echo htmlentities($result->BookingNumber);?></h4>
                ...
                <div class="vehicle_title">
                  ...
                  <p><b>From </b>
                   <?php echo htmlentities($result->FromDate);?> <b>To </b> <?php echo htmlentities($result->ToDate);?></p>
 ...
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Not Confirm yet</a><br>
        ...
        <a href="index.php" onclick="alert('Booking canceled.');">
  <button style="background-color: red; color: white; padding: 10px; border: none; cursor: pointer;">Cancel</button>
</a>
...
<hr />
        ...
        <a href="payment-page.html" class="payment-button">Pay Now</a>
