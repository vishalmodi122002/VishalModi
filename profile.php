  ...
  <div class="container">
    <div class="user_profile_info gray-bg padding_4x4_40">
      ...
      <div class="dealer_info">
        ...
        <?php echo htmlentities($result->DrivingLicence);?>
          ...
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" name="Drivinglicence" value="<?php echo htmlentities($result->ContactNo);?>" id="driving-licence" type="text" required>
            </div>
            <div class="form-group">
    ...
    <select class="form-control white_bg" id="country" name="country">
        <option value="" disabled selected>Select your country</option>
        <option value="usa" <?php echo ($result->Country == 'usa') ? 'selected' : ''; ?>>United States</option>
        <option value="canada" <?php echo ($result->Country == 'canada') ? 'selected' : ''; ?>>Canada</option>
        <option value="uk" <?php echo ($result->Country == 'uk') ? 'selected' : ''; ?>>United Kingdom</option>
        <option value="australia" <?php echo ($result->Country == 'australia') ? 'selected' : ''; ?>>Australia</option>
        <option value="germany" <?php echo ($result->Country == 'germany') ? 'selected' : ''; ?>>Germany</option>
        <option value="france" <?php echo ($result->Country == 'france') ? 'selected' : ''; ?>>France</option>
        <option value="india" <?php echo ($result->Country == 'india') ? 'selected' : ''; ?>>India</option>
        <option value="china" <?php echo ($result->Country == 'china') ? 'selected' : ''; ?>>China</option>
        <option value="brazil" <?php echo ($result->Country == 'brazil') ? 'selected' : ''; ?>>Brazil</option>
        <option value="south_africa" <?php echo ($result->Country == 'south_africa') ? 'selected' : ''; ?>>South Africa</option>
